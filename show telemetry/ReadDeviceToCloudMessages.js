...
const eventHubsCompatibleEndpoint = "sb://iothub-ns-perceptmob-13951780-3ca459b85f.servicebus.windows.net/";

// Event Hub-compatible name
// az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
const eventHubsCompatiblePath = "perceptmobileiothub";

// Primary key for the "service" policy to read messages
// az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
const iotHubSasKey = "fE+F0MfkHGhPN2OwbK3x4a/bqqO93r3PZ3uuNByOAgY=";
...
async function main() {
  console.log("Welcome to DDDPerth - Look at how confident I am that I perceive Cones.");
